// views/adkar/adkar_alkhla_view.dart

import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:rokenalmuslem/controller/adkar/badroomcontroller.dart';
import 'package:rokenalmuslem/view/wedgit/layout/modern_scaffold.dart';

class AdkarAlkhlaView extends StatelessWidget {
  final AdkarAlkhlaController _controller = Get.put(AdkarAlkhlaController());

  AdkarAlkhlaView({super.key});
  ...
  Widget _buildCounter(Map<String, dynamic> dhikr, int index) {
    final theme = Get.theme;
    final scheme = theme.colorScheme;
    return GetX<AdkarAlkhlaController>(
      builder: (_) => Row(
