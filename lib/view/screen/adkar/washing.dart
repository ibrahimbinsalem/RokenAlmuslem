// views/adkar/adkar_alwswi_view.dart

import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:rokenalmuslem/controller/washingcontroller.dart';
import 'package:rokenalmuslem/view/wedgit/layout/modern_scaffold.dart';

class AdkarAlwswiView extends StatelessWidget {
  final AdkarAlwswiController _controller = Get.put(AdkarAlwswiController());

  AdkarAlwswiView({super.key});
  ...
  Widget _buildCounter(Map<String, dynamic> dhikr, int index) {
    final theme = Get.theme;
    final scheme = theme.colorScheme;
    return GetX<AdkarAlwswiController>(
      builder: (_) => Row(
