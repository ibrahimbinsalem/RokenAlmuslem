// views/adkar/adkar_salat_view.dart
...
class AdkarSalatView extends StatelessWidget {
  ...
  final AdkarSalatController _controller = Get.put(AdkarSalatController());

  AdkarSalatView({super.key});
        ...
        children: [
          Positioned.fill(
            child: Opacity(
              opacity: 0.1,
              child: Image.asset(
                'assets/images/مسبحة.png', // تأكد من وجود الصورة بالمسار الصحيح
                fit: BoxFit.cover,
